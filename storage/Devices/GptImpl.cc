...
namespace storage
{
	...
	static const vector<unsigned int> more_supported_ids = {
	    ...
	    ID_LINUX_ROOT_LOONGARCH64, ID_LINUX_ROOT_PPC32, ID_LINUX_ROOT_PPC64BE, ID_LINUX_ROOT_PPC64LE,
	    ID_LINUX_ROOT_RISCV32, ID_LINUX_ROOT_RISCV64, ID_LINUX_ROOT_S390,
	    ID_LINUX_ROOT_S390X, ID_LINUX_ROOT_X86, ID_LINUX_ROOT_X86_64,
	    ID_LINUX_USR_ARM, ID_LINUX_USR_AARCH64, ID_LINUX_USR_LOONGARCH64, ID_LINUX_USR_PPC32,
